cc.Class({
    ...
    start: function() {
        ...
        this._initUI(), this.showHelpDlg(!0);
    ...
    setPlayer1Life: function(life_val) {
    ...
    setPlayer1Score: function(score_val) {
    ...
    setPlayer2Life: function(life_val) {
        0 > life_val && (life_val = 0);
        var _score = this._getChildPath("topUI/scoring1");
